...
- Panel bench facts: TSS-1070 fw 3.003.0021, currently in OOTB app mode; kiosk switch = web config Settings > Applications → "Crestron General Web Application" (HTTPS URL required). Do not switch until hosting + cert are ready. See FRED docs be457823 (deployment) and 84f3b443 (stock-app parity baseline).
