...
- Probed the bench TSS-1070 (192.168.2.155) over its REST API: firmware 3.003.0021, app mode OOTB, `CrestronGeneralWeb` supported. Switch-over steps documented in FRED doc `be457823`. Panel mode NOT yet switched (hosting/cert pending).
...
- Live demo left running: http://localhost:8080 / http://192.168.2.58:8080 (memory provider).

### Decisions of record
- Hardware: TSS-1070 @ 192.168.2.155; deployment via kiosk web-app mode.
